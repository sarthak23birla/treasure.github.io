...
//Ques_id's values must start from 0
   ...
   $answer1=htmlentities(strtolower($_POST["ans1"]));
echo
-+
$answer1;
echo $answer2=htmlentities(strtolower($_POST["ans2"]));
echo $answer2;
echo $answer3=htmlentities(strtolower($_POST["ans3"]));
echo $answer3;
echo $answer4=htmlentities(strtolower($_POST["ans4"]));
echo $answer4;
echo $answer5=htmlentities(strtolower($_POST["ans5"]));
echo $answer5;
echo $ques_id=$_POST["ques_id"];
echo $ques_id;
echo $img_name=$_POST["img_name"];
echo $img_name;
if($_POST["ques_psswd"]=="TSH")
{
